...
### General Disclosures {.unnumbered}
...
Reproducibility: [The authors are applying for a Computational Reproducibility Badge which will be awarded pending checks by the STAR Team.]

### Study Disclosures {.unnumbered}

Preregistration: The hypotheses and methods were not preregistered.The analysis plan was not preregistered. Materials: All study materials are publicly available (https://github.com/ismailg/coax_psych_science). Data: All primary data are publicly available (https://github.com/ismailg/coax_psych_science). Analysis scripts: All analysis scripts are publicly available (https://github.com/ismailg/coax_psych_science). 
...
<!-- Secondary analyses for effect size and correlation between repeated measures.  -->
```{r, include=F}
...
<!-- Linear fixed effects model for returns: ALL ROUNDS BEFORE DEFECTION TRIAL -->
