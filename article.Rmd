...
Funding: I. Guennouni was supported by the UK Engineering and Physical Sciences Research Council under grant EP/S515255/1. QJM. Huys acknowledges support by the UCLH NIHR BRC. He has received fees and options for consultancies for Aya Technologies and Alto Neuroscience.
...
Reproducibility: The results are fully reproducible, and all data and code for the analyses (including the manuscript in R Markdown format) are available at: https://github.com/ismailg/XXXXXXX. The design and analysis plans were not preregistered.
