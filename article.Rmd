...
Reproducibility: The results are fully reproducible, and all data and code for the analyses (including the manuscript in R Markdown format) are available. The design and analysis plans were not preregistered.
